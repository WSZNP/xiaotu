  ...
  <div class="order-item">
    <div class="head">
      ...
      <a @click="$emit('on-delete',order)" href="javascript:;" class="del"
        v-if="[5,6].includes(order.orderState)">删除</a>
    </div>
    <div class="body">
      ...
      <div class="column action">
        ...
        <p><a @click="$router.push(`/member/checkout?orderId=${order.id}`)" v-if="[2,3,4,5].includes(order.orderState)"
            href="javascript:;">再次购买</a></p>
